    ...
    Ember.merge(states.hasElement, {
      ...
      ensureChildrenAreInDOM: function(view) {
        var childViews = view.get('childViews'),
          i, len, childView, previous, buffer;
    ...
    Ember.Handlebars.registerBoundHelper = function(name, fn) {
      ...
      Ember.Handlebars.registerHelper(name, function(property, options) {
        var data = options.data,
          ...
          pathRoot, path, normalized, observer, loc;
...
*/
    ...
    function bind(property, options, preserveContext, shouldDisplay, valueNormalizer) {
      var data = options.data,
        ...
        view = data.view,
        currentContext = this,
        pathRoot, path, normalized, observer;
...
*/
  ...
  (function() {
    define("router", ["route-recognizer"], function(RouteRecognizer) {
      "use strict";
      /**
      @private
  ...
  (function() {
    Ember.controllerFor = function(container, controllerName, context) {
      return container.lookup('controller:' + controllerName) || Ember.generateController(container, controllerName, context);
    };
  ...
  */
      ...
      transitionTo: function(target) {
        ...
        var transitionFunction = function(stateManager, contextOrEvent) {
            var contexts = [],
              transitionArgs, Event = Ember.$ && Ember.$.Event;
