      ...
      DeferredActionQueues.prototype = {
        ...
        flush: function() {
          var queues = this.queues,
            ...
            queueName, queue, queueItems, priorQueueNameIndex, queueNameIndex = 0,
          ...
          outerloop: while (queueNameIndex < numberOfQueues) {
            ...
            var options = queue.options,
              ...
              target, method, args, stack, queueIndex = 0,
    ...
    define("backburner/queue", ["exports"], function(__exports__) {
      ...
      Queue.prototype = {
        ...
        pushUnique: function(target, method, args, stack) {
          var queue = this._queue,
            currentTarget, currentMethod, i, l;
...
*/
    ...
    var Mixin, REQUIRED, Alias, a_map = Ember.ArrayPolyfills.map,
...
*/
  ...
  (function() {
    define("rsvp/all", ["rsvp/defer", "exports"], function(__dependency1__, __exports__) {
      "use strict";
    ...
    define("rsvp", ["rsvp/events", "rsvp/promise", "rsvp/node", "rsvp/all", "rsvp/hash", "rsvp/defer", "rsvp/config", "rsvp/resolve", "rsvp/reject", "exports"], function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __dependency5__, __dependency6__, __dependency7__, __dependency8__, __dependency9__, __exports__) {
      "use strict";
...
*/
  ...
  */
      ...
      generateElement: function() {
        var tagName = this.tagNames.pop(),
          // pop since we don't need to close
    ...
    Ember.Handlebars.registerBoundHelper = function(name, fn) {
      ...
      function helper() {
        var properties = slice.call(arguments, 0, -1),
          ...
          normalized, pathRoot, path, loc, hashOption;
...
*/
    function evaluateMultiPropertyBoundHelper(context, fn, normalizedProperties, options) {
      var numProperties = normalizedProperties.length,
        ...
        watchedProperties, boundOption, bindView, loc, property, len;
...
*/
  ...
  (function() {
    define("router", ["route-recognizer", "rsvp"], function(RouteRecognizer, RSVP) {
      "use strict";
      /**
      @private
     ...
     */
      function getMatchPoint(router, handlers, objects, inputParams) {
        ...
        var objectsToMatch = objects.length,
          ...
          providedModels = {},
          i, currentHandlerInfos = router.currentHandlerInfos || [],
          params = {},
        ...
        for (i = handlers.length - 1; i >= 0; i--) {
          ...
          if (handlerObj.isDynamic) {
            ...
            if (objectsToMatch > 0) {
              ...
              hasChanged = true;
              providedModels[handlerName] = activeTransition.providedModels[handlerName] || activeTransition.resolvedModels[handlerName];
            } else {
    ...
    */
     ...
     */
      function performTransition(router, recogHandlers, providedModelsArray, params, data) {
        ...
        validateEntry(transition, handlerInfos, 0, matchPointResults.matchPoint, matchPointResults.handlerParams).then(transitionSuccess, transitionFailure);
     ...
     */
      function validateEntry(transition, handlerInfos, index, matchPoint, handlerParams) {
        ...
        return RSVP.resolve().then(handleAbort).then(beforeModel).then(null, handleError).then(handleAbort).then(model).then(null, handleError).then(handleAbort).then(afterModel).then(null, handleError).then(handleAbort).then(proceed);
...
*/
   ...
   */
    ...
    function enterLoadingState(router) {
      if (router._loadingStateActive || !router._shouldEnterLoadingState) {
        return;
      }

      var loadingRoute = router.router.getHandler('loading');
      if (loadingRoute) {
        if (loadingRoute.enter) {
          loadingRoute.enter();
        }
  ...
  */
      Ember.Handlebars.registerHelper('control', function(path, modelPath, options) {
        ...
        if (children.hasOwnProperty(controlID)) {
          ...
          container = get(controller, 'container'), subContainer = container.child();
